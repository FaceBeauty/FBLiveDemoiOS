...
static FBCaptureSessionManager *shareManager = NULL;
static dispatch_once_t token;

@interface FBCaptureSessionManager ()<AVCaptureVideoDataOutputSampleBufferDelegate>

@end

@implementation FBCaptureSessionManager

// MARK: --单例初始化方法--
+ (FBCaptureSessionManager *)shareManager {
    dispatch_once(&token, ^{
        shareManager = [[FBCaptureSessionManager alloc] init];
    });
    return shareManager;
}
...
- (void)destroy{
    ...
    [FBCaptureSessionManager releaseShareManager];
}
